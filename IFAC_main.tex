...
This is evident when considering an heterogeneous fleet where the strenghts
...
the reader is refered to the work of~\cite{Maldonado2024}.
...
At the end of all experiments, even the ground vehicles appear to oscilllate. 
...
and $\bar{t}_2 = \SI{8.92}{\second}$, respectively, where:
\begin{equation}
...
After some simulations, the proposed scheme has  been extremely validated 
...
the quadrotor'altitude in the formation dynamics 
