...
\author[First,Second]{\textcolor{red}{?}}
...
\begin{equation}
    \begin{cases}
        \ddot{x}^F_A = - T \sin \theta \\
        \ddot{y}^F_A = T \cos \theta \sin \phi \\
        \ddot{z}^F_A = T \cos \theta \cos \phi  - m\, g\\
    \end{cases}
\end{equation}
...
\textcolor{red}{Spiegare brevemente T, m ,g , cambia figure per essere coerente nella notazione}
...
\begin{figure}
    ...
    \begin{subfigure}{0.31\columnwidth}
        % trim = left bottom right top (in points or any unit)
        \hspace{0.5cm}
        \includegraphics[trim={1.2cm 0.5cm 2.5cm 0.5cm}, clip, width=3cm]{images/drone_topView.png}
    ...
    \begin{subfigure}{0.31\columnwidth}
        ...
        \vspace{-1.3cm}
        \includegraphics[trim={0cm 0cm 0.5cm 0cm}, clip, width=3cm]{images/drone_roll.png}
        \vspace{0.7cm}
    ...
    \begin{subfigure}{0.31\columnwidth}
        ...
        % \vspace{0.9cm}
        % \vspace{-0.01cm}
        \includegraphics[trim={0.8cm 0.1cm 0cm 0.5cm}, clip, width=3cm]{images/drone_pitch.png}
        % \vspace{0.1cm}
        % \vspace{0.9cm}
...
%     \begin{subfigure}{0.31\columnwidth}
%         \hspace{0.5cm}
%         \includegraphics[width=3cm]{images/drone_topView.png}
%         \caption{Drone's body frame $B$ and FL-AIR frame $F$.}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}{0.31\columnwidth}
%         \hspace{0.5cm}
%         \includegraphics[width=3cm]{images/roll_drone.png}
%         \caption{Roll $\phi$ w.r.t  the frame $B$.}
%     \end{subfigure}
%     \hfill
%     \begin{subfigure}{0.31\columnwidth}
%         \hspace{0.3cm}
%         \vspace{-0.2cm}
%         \includegraphics[width=3cm]{images/pitch_drone.png}
%         \vspace{-0.3cm}
%         \caption{Pitch $\theta$ w.r.t  the frame $B$.\\}
%     \end{subfigure}
%     \caption{Quadcopter's orientation.} 
%     \label{fig:drone_roll_pitch_frames}
% \end{figure}

Secondly, let suppose that the $Z$-controller is 
such that the drone's mass is compensated in a short time.
