...
in solid black, while the actual inter distances at the end of the simulation 
...
the dotted shape appears indeed to be a translated version of the solid one.
...
respectively.
For these reasons, the final geometry of the team (dotted black line) in Fig.~\ref{fig:exp_noObstacles}
